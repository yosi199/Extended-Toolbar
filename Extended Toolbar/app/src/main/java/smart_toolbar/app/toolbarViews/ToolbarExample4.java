 ...
 */
public class ToolbarExample4 extends ToolbarViewBaseInterface {
    ...
    public static ToolbarViewInterface getInstance() {
        return (ToolbarViewInterface) LayoutInflater.from(App.getAppContext()).inflate(R.layout.toolbar_example4, null, false);
    }
