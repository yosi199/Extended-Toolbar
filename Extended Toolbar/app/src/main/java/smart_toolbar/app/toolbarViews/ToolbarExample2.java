 ...
 */
public class ToolbarExample2 extends ToolbarViewBaseInterface {
    ...
    public static ToolbarViewInterface getInstance() {
        return (ToolbarViewInterface) LayoutInflater.from(App.getAppContext()).inflate(R.layout.toolbar_example2, null, false);
    }
